<template>
  <div class="ml-26 gap-6 flex flex-col h-screen justify-center w-[400px]">
    <t-typography-title level="h1">登录到<br/>PurePanel</t-typography-title>
    ...
    <t-typography-text class="absolute bottom-10" theme="secondary">Copyright @ 2021-2025 PurePanel. All Rights Reserved
    </t-typography-text>
  </div>
</template>
